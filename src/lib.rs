// src/lib.rs
/*
 * Core library for CuratorContent
 */
...
#[derive(Debug)]
pub struct CuratorContentProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CuratorContentProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CuratorContent processing");
    
    let mut processor = CuratorContentProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CuratorContentProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CuratorContentProcessor::new(false);
